<?php 
    ...
    if(isset($_GET['edit'])){
        ...
        if(isset($_POST['update'])){
            ...
            $sql_updata = "UPDATE `posts` SET `title`= '$title' , `contect`= '$contect' where id = $id";
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST">
                                ...
                                <div class="form-group mt-2">
                                    <label>Content</label>
                                    <textarea class="form-control" name="contect"><?php echo $data['contect'] ?></textarea>
                                </div>

                                <div class="d-grid gap-2 col-12 mx-auto mt-5">
                                    <button  class="btn btn-block btn-primary" name="update">Update Post</button>
                                </div>
                            </form>
                        </div>
                    </div>
